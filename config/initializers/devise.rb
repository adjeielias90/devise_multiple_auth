...
Devise.setup do |config|
  ...
  # config.secret_key = '818f422257012d13e3698fa41438fb44fe73157e9960e81c58deaf206020ec3d8e4ff4ad399d0ed30b14b7ead4ac06090634703af5cdf2c41713f9f9503babcd'
  ...
  # config.pepper = 'c249abdb047c5cec84a7f308395ac60c074081cb84527c116729527870f91c1a6aabd5abec93838e7c54fee5f8aa1106d8560ba0baf6cda227ae6a6a685e4124'
  ...
  config.radius_server = '192.168.22.140'
  ...
  config.radius_server_secret = 'Password@1'

  # Configure the time in seconds to wait for a radius server to respond.
  config.radius_server_timeout = 60
  ...
  # be loaded.
  #
  # config.radius_dictionary_path = ''

  # Option to handle radius timeout as authentication failure
  #
  config.handle_radius_timeout_as_failure = false
